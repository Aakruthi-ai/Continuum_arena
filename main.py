...
import sys
import math
import asyncio  # Required for clean web browser execution without hanging
...
async def run_game():
    ...
    # --- Responsive Multi-line Word-Wrap Renderer ---
    ...
    while running:
        ...
        screen.blit(fonts["title"].render("CHRONO-ARENA // SECTOR ONSLAUGHT SYSTEM", True, WHITE), (20, 20))
